...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_banner_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../node_modules/css-loader/dist/cjs.js!./banner.css */ "./node_modules/css-loader/dist/cjs.js!./src/banner.css");
...
var Banner = /*#__PURE__*/function (_Component) {
  function Banner(props) {
    ...
    _this = _callSuper(this, Banner, [props]);
    _this.state = {
      visibleTime: 0,
      show: undefined
    };
  ...
  return _createClass(Banner, [{
    ...
    key: "hideBanner",
    value: function () {
      var _hideBanner = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
...
Banner.propTypes = {
  ...
  css: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().object),
  visibleTime: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().number),
  image: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().string),
  imageClass: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().string),
  transitionAppearTime: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().number),
  transitionTime: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().number),
  showBanner: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().bool),
